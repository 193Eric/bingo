var t = t || function(t, e) {
    var r = {}, n = r.lib = {}, i = n.Base = function() {
        ...
        _process: function(e) {
            var r = this._data, n = r.words, i = r.sigBytes, o = this.blockSize, a = i / (4 * o), e = (a = e ? t.ceil(a) : t.max((0 | a) - this._minBufferSize, 0)) * o, i = t.min(4 * e, i);
            if (e) {
...
!function(e) {
    var r = t, n = (i = r.lib).WordArray, i = i.Hasher, s = r.algo, o = [], a = [];
    !function() {
        function t(t) {
            return 4294967296 * (t - (0 | t)) | 0;
        }
        for (var r = 2, n = 0; 64 > n; ) (function(t) {
            for (var r = e.sqrt(t), n = 2; n <= r; n++) if (!(t % n)) return !1;
            return !0;
        })(r) && (8 > n && (o[n] = t(e.pow(r, .5))), a[n] = t(e.pow(r, 1 / 3)), n++), r++;
    }();
    var c = [], s = s.SHA256 = i.extend({
        _doReset: function() {
    ...
    r.SHA256 = i._createHelper(s), r.HmacSHA256 = i._createHmacHelper(s);
}(Math), function() {
    var e = t, r = e.enc.Utf8;
    e.algo.HMAC = e.lib.Base.extend({
        init: function(t, e) {
            t = this._hasher = t.create(), "string" == typeof e && (e = r.parse(e));
            var n = t.blockSize, i = 4 * n;
            e.sigBytes > i && (e = t.finalize(e));
            for (var s = this._oKey = e.clone(), o = this._iKey = e.clone(), a = s.words, c = o.words, h = 0; h < n; h++) a[h] ^= 1549556828, 
            c[h] ^= 909522486;
