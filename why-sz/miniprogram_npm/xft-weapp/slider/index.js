...
var t = require("../common/component"), a = require("../mixins/touch"), e = require("../common/version"), i = require("../common/utils");
...
t.VantComponent({
    ...
    methods: {
        ...
        onTouchMove: function(t) {
            ...
            this.touchMove(t), this.dragStatus = "draging", i.getRect(this, ".van-slider").then(function(t) {
                var e = a.deltaX / t.width * a.getRange();
        ...
        onClick: function(t) {
            ...
            if (!this.data.disabled) {
                var e = this.data.min;
                i.getRect(this, ".van-slider").then(function(i) {
