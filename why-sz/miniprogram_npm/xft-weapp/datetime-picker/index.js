...
var s = require("../common/component"), l = require("../common/validator"), m = require("../picker/shared"), p = new Date().getFullYear(), c = function(e, t) {
    return t;
};
...
s.VantComponent({
    ...
    methods: {
        updateValue: function() {
            var e = this, t = this.data, n = this.correctValue(t.value), a = n === t.innerValue;
