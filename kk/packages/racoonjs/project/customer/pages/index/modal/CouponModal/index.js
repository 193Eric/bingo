(wx.webpackJsonp = wx.webpackJsonp || []).push([ [ 76 ], {
    478: function(e, t, o) {
        "use strict";
        ...
        var R = o(0), r = _interopRequireDefault(R), c = _interopRequireDefault(o(11));
        ...
        var a = (function _inherits(e, t) {
            ...
            value: function componentWillMount() {
                ...
                i && (p = i), p.forEach(function(e) {
                    ...
                    if (2 == e.whetherDay && n < t) {
                        var r = (0, c.default)(t).format("YYYY.M.D HH:mm");
                        e.validDayEndText = r + "后可用";
                    } else if (864e5 <= o - n) {
                        var a = (0, c.default)(o).format("YYYY.M.D HH:mm");
            ...
            value: function _createData(e, t, o) {
                ...
                var r = this.$prefix, a = (0, R.genCompid)(r + "$compid__23"), i = S(a, 2), u = i[0], p = i[1], c = this.__props, l = c.isRegisterMode, s = c.$store, d = c.extraData;
                if (!s) return null;
                var f = 15498144e5, m = 15502464e5, _ = Date.now(), h = "https://qn-cdn-pic.feng1.com/pop_pict_orange_nor.png", y = "coupon-modal--coming";
                l || (y = "coupon-modal--received", h = "https://qn-cdn-pic.feng1.com/pop_pict_orange2_nor.png"), 
                ...
                var O = (0, R.internal_inline_style)(b), M = (0, R.internal_inline_style)(b), $ = C.map(function(e, t) {
                    return e = {
                        ...
                        $loopState__temp2: n._createCouponItemData(r + "bezzzzzzzz" + t)(e.$original),
                        $original: e.$original
                    };
                });
        ...
        function CouponModal() {
            ...
            return e.$usedState = [ "anonymousState__temp3", "anonymousState__temp4", "loopArray1", "$compid__23", "$store", "autoReceiveCoupon", "typeClassName", "headerImageUrl", "isShowCouponRecord", "isShow", "extraData", "isRegisterMode", "actions" ], 
            e.customComponents = [ "Modal" ], e;
        }
        a.$$events = [], a.$$componentPath = "packages/racoonjs/project/customer/pages/index/modal/CouponModal/index", 
