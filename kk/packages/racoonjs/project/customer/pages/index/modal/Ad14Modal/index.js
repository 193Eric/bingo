(wx.webpackJsonp = wx.webpackJsonp || []).push([ [ 75 ], {
    511: function(t, e, o) {
        "use strict";
        ...
        var i = (function _inherits(t, e) {
            ...
            value: function _createData(t, e, o) {
                ...
                var n = this.$prefix, a = (0, f.genCompid)(n + "$compid__37"), i = d(a, 2), s = i[0], u = i[1], c = this.__state.isShow, l = this.__props.extraData, p = "";
                return l && (p = l.imgUrl), this.anonymousFunc0 = function() {
                    return r.setState({
                        isShow: !1
                    });
                }, f.propsManager.set({
        ...
        function Ad14Modal() {
            ...
            return t.$usedState = [ "$compid__37", "imgUrl", "isShow", "actions", "extraData" ], 
            t.customComponents = [ "Modal" ], t;
        }
        i.$$events = [ "handleImageClick" ], i.$$componentPath = "packages/racoonjs/project/customer/pages/index/modal/Ad14Modal/index", 
