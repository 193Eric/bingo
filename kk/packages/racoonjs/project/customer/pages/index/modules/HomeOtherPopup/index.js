(wx.webpackJsonp = wx.webpackJsonp || []).push([ [ 79 ], {
    480: function(t, e, r) {
        "use strict";
        ...
        var n = (function _inherits(t, e) {
            ...
            value: function _createData(t, e, r) {
                ...
                return p && (o = void 0, o = this._createTaskCardPopupData(a + "bfzzzzzzzz")()), 
            ...
            value: function _createTaskCardPopupData(h) {
                var m = this;
                return function() {
                    var t = (0, y.genCompid)(h + "$compid__24"), e = v(t, 2), r = e[0], o = e[1], a = m.props, n = a.otherPopupStatus, u = a.otherPopupData;
                    if (!u) return null;
                    var i = (0, P.default)("task-card-popup flip-container", {
                        show: "taskCard" === n,
                        hide: "taskCard_hide" === n
                    }), p = u.finishNum, s = void 0 === p ? 0 : p, c = u.targetNum, l = Math.min(s / c * 100, 100), f = s === c, d = 2 == u.cycleType ? "本周" : "活动期间", _ = m._createOrderPriceData(h + "bgzzzzzzzz")(u.targetValue);
        ...
        n.$$componentPath = "packages/racoonjs/project/customer/pages/index/modules/HomeOtherPopup/index", 
