(wx.webpackJsonp = wx.webpackJsonp || []).push([ [ 80 ], {
    482: function(t, e, r) {
        "use strict";
        ...
        var s = (function _inherits(t, e) {
            ...
            value: function draw(t) {
                if (t) {
                    ...
                    var i = (.01 * e * 270 + 135) * (Math.PI / 180), c = 106 + Math.cos(o) * r, p = 106 + Math.cos(i) * r, u = 106 + Math.sin(o) * r, l = 106 + Math.sin(i) * r, f = this.ctx.createLinearGradient(c, u, p, l);
        ...
        s.$$events = [], s.$$componentPath = "packages/racoonjs/project/customer/pages/index/modules/HomeOtherPopup/progressBar", 
        s.options = {
            addGlobalClass: !0
