...
!function(e) {
    ...
    GameGlobal.__isAdapterInjected || (GameGlobal.__isAdapterInjected = !0, function() {
        ...
        "devtools" === wx.getSystemInfoSync().platform) {
            for (var e in r) {
    ...
    var a = v(n(10)), i = v(n(11)), u = v(n(18)), c = v(n(19)), l = v(n(20)), s = v(n(12)), f = v(n(13)), d = v(n(21)), p = v(n(5)), h = v(n(22)), y = v(n(23));
    function v(e) {
    ...
    var o, r = n(3), a = (o = r) && o.__esModule ? o : {
        default: o
    };
    var i = wx.getSystemInfoSync(), u = i.screenWidth, c = i.screenHeight, l = i.devicePixelRatio, s = t.innerWidth = u, f = t.innerHeight = c;
    ...
    var n, o = Date;
    if (wx.getPerformance) try {
        o = wx.getPerformance();
    } catch (e) {}
    var r = o.now(), a = Object.assign({}, o, {
        now: function() {
            return (o.now() - r) / 1e3;
        }
    });
    n = "devtools" === wx.getSystemInfoSync().platform ? o : a, t.default = n;
}, function(t, n, o) {
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), n.HTMLCanvasElement = n.HTMLImageElement = void 0;
    var r, a = o(5), i = (r = a) && r.__esModule ? r : {
        default: r
    };
    function u(e, t) {
    ...
    var o = function(e) {
        ...
        if (null != e) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
        return t.default = e, t;
    }(n(1)), r = c(n(5)), a = c(n(12)), i = c(n(13)), u = c(n(10));
    function c(e) {
        return e && e.__esModule ? e : {
            default: e
        };
    ...
    var c = new WeakMap(), l = new WeakMap(), s = (new WeakMap(), new WeakMap(), function(t) {
        function n(t) {
            ...
            o.HAVE_ENOUGH_DATA = 4, o.readyState = 0, l.set(o, "");
        ...
        return function(t, n) {
            ...
            value: function() {
                var e = new n();
                return e.loop = c.get(this).loop, e.autoplay = c.get(this).autoplay, e.src = this.src, 
                e;
            }
        }, {
            key: "currentTime",
    ...
    var o, r = function(e) {
        ...
        if (null != e) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
        return t.default = e, t;
    }(n(1)), a = n(11), i = (o = a) && o.__esModule ? o : {
        default: o
    }, u = n(9);
    var c = function e(t) {
        !function(e, t) {
    ...
    var s = function() {
        this.target = r.canvas, this.currentTarget = r.canvas, this.preventDefault = u.noop, 
        this.stopPropagation = u.noop, this.type = "mousewheel";
    };
    null != wx.onWheel && wx.onWheel(function(e) {
        var t = new s();
        t.deltaX = e.deltaX, t.deltaY = e.deltaY, t.wheelDelta = e.deltaY, t.deltaZ = e.deltaZ, 
        t.pageX = e.x, t.pageY = e.y, t.timeStamp = e.timeStamp, i.default.dispatchEvent(t);
    });
}, function(e, t, n) {
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var s = function() {
        function e() {
            ...
            this.withCredentials = !1, this._customTimeout = null, a.set(this, {
        ...
        return n(e, [ {
            ...
            value: function() {
                ...
                var u = {
                    ...
                    fail: function(e) {
                        var n = e.errMsg;
                        -1 !== n.indexOf("abort") ? c.call(t, "abort") : -1 !== n.indexOf("timeout") || -1 !== n.indexOf("超时") ? c.call(t, "timeout", n) : c.call(t, "error", n), 
                        c.call(t, "loadend");
                    }
                };
                t._customTimeout && (u.timeout = t._customTimeout), wx.request(u);
            }
        }, {
