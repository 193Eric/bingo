...
function n(e, n) {
    ...
    if (!(r instanceof n)) {
        var i = function() {};
        i.prototype = n.prototype, t(r, i = new i()), e.prototype = r = i;
    }
...
1), N.DOMSTRING_SIZE_ERR = (g[2] = "DOMString size error", 2), N.HIERARCHY_REQUEST_ERR = (g[3] = "Hierarchy request error", 
3)), w = (N.WRONG_DOCUMENT_ERR = (g[4] = "Wrong document", 4), N.INVALID_CHARACTER_ERR = (g[5] = "Invalid character", 
5), N.NO_DATA_ALLOWED_ERR = (g[6] = "No data allowed", 6), N.NO_MODIFICATION_ALLOWED_ERR = (g[7] = "No modification allowed", 
7), N.NOT_FOUND_ERR = (g[8] = "Not found", 8)), E = (N.NOT_SUPPORTED_ERR = (g[9] = "Not supported", 
9), N.INUSE_ATTRIBUTE_ERR = (g[10] = "Attribute in use", 10));

N.INVALID_STATE_ERR = (g[11] = "Invalid state", 11), N.SYNTAX_ERR = (g[12] = "Syntax error", 
12), N.INVALID_MODIFICATION_ERR = (g[13] = "Invalid modification", 13), N.NAMESPACE_ERR = (g[14] = "Invalid namespace", 
14), N.INVALID_ACCESS_ERR = (g[15] = "Invalid access", 15);
...
function D(e) {
    ...
    if (e._inc != n) {
        ...
        ee(e, "length", r.length), t(r, e), e._inc = n;
    }
}
...
function L(e, t, n) {
    var r = t.parentNode;
    if (r && r.removeChild(t), t.nodeType === f) {
        var i = t.firstChild;
        if (null == i) return t;
        var o = t.lastChild;
    } else i = o = t;
    ...
    return B(e.ownerDocument || e, e), t.nodeType == f && (t.firstChild = t.lastChild = null), 
    t;
}
...
function K(e, t, n, r, l) {
    ...
    switch (e.nodeType) {
      case i:
        l || (l = []);
        l.length;
        var m = e.attributes, N = m.length, g = e.firstChild, v = e.tagName;
        n = "http://www.w3.org/1999/xhtml" === e.namespaceURI || n, t.push("<", v);
        for (var w = 0; w < N; w++) {
        ...
        if (g || n && !/^(?:meta|link|img|br|hr|input)$/i.test(v)) {
            if (t.push(">"), n && /^script$/i.test(v)) for (;g; ) g.data ? t.push(g.data) : K(g, t, n, r, l), 
            g = g.nextSibling; else for (;g; ) K(g, t, n, r, l), g = g.nextSibling;
            t.push("</", v, ">");
        } else t.push("/>");
        return;
      ...
      case p:
      case f:
        for (g = e.firstChild; g; ) K(g, t, n, r, l), g = g.nextSibling;
        return;
...
y.prototype = Error.prototype, t(N, y), b.prototype = {
        ...
        return function t(n, r, a) {
            ...
            switch (u.ownerDocument = n, u.nodeType) {
              case i:
                ...
                h._ownerElement = u;
                for (var d = 0; d < p; d++) u.setAttributeNode(t(n, c.item(d), !0));
                break;

              case o:
                a = !0;
            }
            if (a) for (var f = r.firstChild; f; ) u.appendChild(t(n, f, a)), f = f.nextSibling;
            return u;
    ...
    createElementNS: function(e, t) {
        var n = new V(), r = t.split(":"), i = n.attributes = new _();
    ...
    appendChild: function(e) {
        return e.nodeType === f ? this.insertBefore(e, null) : function(e, t) {
            var n = t.parentNode;
            if (n) {
                var r = e.lastChild;
                n.removeChild(t);
...
n(V, A), k.prototype.nodeType = o, n(k, A), F.prototype = {
    ...
    nodeType: u
}, n(z, F), $.prototype.nodeType = d, n($, A), X.prototype.nodeType = m, n(X, A), 
G.prototype.nodeType = l, n(G, A), H.prototype.nodeType = s, n(H, A), W.prototype.nodeName = "#document-fragment", 
W.prototype.nodeType = f, n(W, A), q.prototype.nodeType = c, n(q, A), Z.prototype.serializeToString = function(e, t, n) {
    return Q.call(e, t, n);
